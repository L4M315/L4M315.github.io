...
<a href="https://raw.githubusercontent.com/L4M315/L4M315.github.io/refs/heads/main/_homeworks/is445_hw5/ufo-scrubbed-geocoded-time-standardized-00.csv" class="btn" style="display:inline-block; padding:8px 16px; background:#4c78a8; color:white; text-decoration:none; border-radius:4px; margin-right:8px;">Data</a>
<a href="https://github.com/L4M315/L4M315.github.io/blob/main/_homeworks/is445_hw5/ufo_analysis.ipynb" class="btn" style="display:inline-block; padding:8px 16px; background:#333; color:white; text-decoration:none; border-radius:4px;">Analysis</a>
...
<vegachart schema-url="{{ site.baseurl }}/_homeworks/is445_hw5/heatmap.json" style="width: 100%"></vegachart>
...
<vegachart schema-url="{{ site.baseurl }}/_homeworks/is445_hw5/us_map.json" style="width: 100%"></vegachart>
